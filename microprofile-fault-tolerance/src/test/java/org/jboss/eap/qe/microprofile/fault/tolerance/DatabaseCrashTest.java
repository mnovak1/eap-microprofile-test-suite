...
public class DatabaseCrashTest {
    ...
    public static final String APPLICATION_URL = "http://localhost:8080/" + APPLICATION_NAME;
    ...
    public static void startDatabase() throws Exception {
        ...
        postgresDB = new Docker.Builder("postgres", "postgres:12")
                ...
                .withEnvVar("POSTGRES_DB", "test-database")
                ...
                .build();
        postgresDB.start();
        get(APPLICATION_URL + "/?op=createTable").then().assertThat()
                .body(containsString("Table created."));
    }
    ...
    public void testRetryWithDBKill() throws Exception {
        ...
        get(APPLICATION_URL + "/?op=insertRecordWithRetry").then().assertThat()
        ...
        Future<String> retryCall = Executors.newSingleThreadExecutor()
                .submit(() -> get(APPLICATION_URL + "/?op=insertRecordWithRetry").body().asString());
        ...
        Awaitility.await("@Retry is not working. Check that microprofile fault tolerance is working.")
                ...
                .until(() -> Integer.valueOf(get(APPLICATION_URL + "/?op=getInsertRecordCount")
                        .body().print()) > 3);
    ...
    public void testCircuitBreakerWithDBKill() throws Exception {
        // check insert works
        get(APPLICATION_URL + "/?op=insertRecord").then().assertThat()
                .body(containsString("New record inserted."));
        ...
        for (int i = 0; i < 10; i++) {
            get(APPLICATION_URL + "/?op=insertRecordWithCircuitBreaker");
        }
